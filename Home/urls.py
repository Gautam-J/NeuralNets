...
from .views import ServicesView, get_services, AboutView, ContactView, ListAllModelsView, SearchResultsView
...
urlpatterns = [
    ...
    path('search/', SearchResultsView.as_view(), name='searchresults-view'),
]
